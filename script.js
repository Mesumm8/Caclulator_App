...
function buttonClick(event) {
    // get values from the button clicked
...
function evaluateExpression() {
    ...
    // check if evalresult is NaN or Infinity, if it is, return a space character ''
...
function negate() {
    ...
    if (expression === '' && result !== '') {
        ...
        // remove the negative sign if the expression is already negative
